                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                            <div className="card m-2 ring-2 ring-blue-500/50 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <div className="p-5 flex flex-col">
                                    ...
                                    <div className="flex justify-end">
                                        ...
                                        <a href="https://www.figma.com/file/28R221I3RXefRB6SylNrCr/Wireframe-%2B-High-Fidelity-POS-Toserba?type=design&node-id=0%3A1&mode=design&t=u15Et7PVtPqTHQYq-1" target="blank" className="transition ease-in-out delay-300 bg-green-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-200 text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">
                                            Figma🎨
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="card m-2 ring-2 ring-blue-500/50 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <div className="p-5 flex flex-col">
                                    ...
                                    <div className="flex justify-end">
                                        <a href="https://www.figma.com/file/YOnFqof5SjCFMkL0VxKBhS/Prototype-E-commerce?type=design&mode=design&t=1GrwPelmbz4DLf2D-1" target="blank" className="transition ease-in-out delay-300 bg-green-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-200 text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 ">
                                            Figma🎨
                                        </a>
                                    </div>
                                </div>
